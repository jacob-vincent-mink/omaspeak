...
[`build.sh`](build.sh) produces the shared native stack used by Omaspeak's
Linux x86_64 release workflow. It builds one ONNX Runtime with its CPU engine,
...
The release archive contains one Omaspeak executable, the base sherpa/ONNX
