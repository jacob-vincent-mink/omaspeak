...
Examples:
  python3 scripts/verify-setup-tui.py --binary target/debug/omaspeak --suite smoke
  python3 scripts/verify-setup-tui.py --binary ~/.local/bin/omaspeak --suite full \
    --model-cache ~/.local/share/omaspeak/models/supertonic-3-openvino \
    --custom-model-cache ~/.local/share/omaspeak/models/kokoro-82m-gguf --model-down 1
"""
