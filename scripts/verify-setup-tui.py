...
Examples:
  python3 scripts/verify-setup-tui.py --binary target/debug/omaspeak --customize-review
  python3 scripts/verify-setup-tui.py --binary target/debug/omaspeak --model-cache ~/.local/share/omaspeak/models/MODEL
"""
...
APP = "omaspeak"
CUSTOM_TABS = ("Choose runtime", "Choose device", "Choose model", "Choose voice", "Choose output", "Review and apply")
